...
{
    public partial class ConsultClient : Form
    {
        ...
        string caminho = System.IO.Path.Combine(AppDomain.CurrentDomain.BaseDirectory, @"C:\Otavio.1DS\Corserius-forms\Corserius-forms\CadastroCliente.txt");
        ...
        private void btnConsultar_Click(object sender, EventArgs e)
        {
            ...
            dgListaCli.DataSource = usuarios;
        }
